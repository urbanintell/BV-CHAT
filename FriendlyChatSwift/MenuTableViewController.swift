...
class MenuTableViewController: UITableViewController {
    var menuItems = ["Sign out"]
    var currentItem = "Sign out"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.button.titleLabel?.text = menuItems[indexPath.row]
        cell.button.titleLabel?.textColor = (menuItems[(indexPath as IndexPath).row] == currentItem) ? UIColor.white : UIColor.gray
